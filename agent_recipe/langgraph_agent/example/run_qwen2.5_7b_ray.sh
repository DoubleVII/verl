...
model_path=/home/nfs06/yangs/LLM/Qwen/Qwen2.5-7B-Instruct
...
experiment_name="math_expression_tool_qwen2.5_7b"

# Checkpoint directory
default_local_dir=$DATA_ROOT/ckpt/math_expression5/$experiment_name
